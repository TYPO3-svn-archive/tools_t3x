 ...
 *
 * $Id: extensionManager.php,v 1.1 2006/10/23 12:57:40 dkd-otto Exp $
 *
...
';
	...
	*******************************/
	...
	/**
	 * Gathers information about extension in $path
	 *
	 * @param	string		Absolute path to local, global or system extension
	 * @param	string		Extension key of a local, global or system extension
	 * @param	array		Array with information for each extension key found. Notice: passed by reference
	 * @param	array		Categories index: Contains extension titles grouped by various criteria.  Notice: passed by reference
	 * @param	string		Path-type: L, G or S
	 * @return	void		"Returns" content by reference
	 * @access private
	 ...
	 * @see getInstalledExtensions()
	 */
	function getExtDetails($path, $extKey, &$list, &$cat, $type ) {
		if (@is_dir($path))	{
			if (@is_file($path.'/ext_emconf.php'))	{
				...
				if (is_array($emConf))	{
					...
					$list[$extKey]['type'] = $type;
					$list[$extKey]['EM_CONF'] = $emConf;
					$list[$extKey]['files'] = t3lib_div::getFilesInDir($path);
